...
const DarkModeSwitcher = () => {
    ...
    return (
        <li>
            <label
                className={`relative m-0 block h-7.5 w-14 rounded-full ${colorMode === ColorTheme.Dark ? 'bg-primary' : 'bg-stroke'}`}
            >
                <input
                    type="checkbox"
                    onChange={() => {
                        if (typeof setColorMode === 'function') {
                            // @ts-ignore
                            setColorMode(colorMode === ColorTheme.Light ? ColorTheme.Dark : ColorTheme.Light);
                            dispatch(setAppColorMode(appColorMode === ColorTheme.Dark ? ColorTheme.Light : ColorTheme.Dark));
                        }
                    }}
