...
const DropdownUser = ({ onSignOut }: DropdownUserProps) => {
        ...
        <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
            ...
            {dropdownOpen && (
                ...
                >
                    ...
                    <button className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base" onClick={() => onSignOut()}>
                        <svg
                            className="fill-current"
                            width="22"
                            height="22"
