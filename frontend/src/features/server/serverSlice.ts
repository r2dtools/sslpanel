...
export const fetchServerRenewalLogs = createAsyncThunk(
    'server/renewal-logs',
...
export const serverSlice = createSlice({
    ...
    extraReducers: builder => {
        builder
            ...
            }).addCase(fetchServerRenewalLogs.pending, state => {
                state.renewalLogsStatus = FetchStatus.Pending;
            })
            .addCase(fetchServerRenewalLogs.fulfilled, (state, action) => {
                state.renewalLogsStatus = FetchStatus.Succeeded;
                state.renewalLogs = action.payload;
            })
            .addCase(fetchServerRenewalLogs.rejected, (state, action) => {
