                ...
                <div className="p-4 md:p-6 xl:p-7.5">
                    <div className="flex items-start justify-between">
                        ...
                        <div x-data="{openDropDown: false}" className="relative">
                            ...
                            <div x-show="openDropDown" className="absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark" style={{ display: 'none' }}>
                ...
                <div className="p-4 md:p-6 xl:p-7.5">
                    <div className="flex flex-col gap-7">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-1/12">
                                <span className="inline-block rounded bg-red/[0.08] px-2.5 py-0.5 text-sm font-medium text-red">Lost Lead</span>
                            </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-1/12">
                                <span className="inline-block rounded bg-meta-3/[0.08] px-2.5 py-0.5 text-sm font-medium text-meta-3">Active</span>
                            </div>
                            <div className="hidden w-2/12 2xsm:block md:w-1/12">
                                <button className="mx-auto block hover:text-meta-1">
                                    <svg className="mx-auto fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-1/12">
                                <span className="inline-block rounded bg-red/[0.08] px-2.5 py-0.5 text-sm font-medium text-red">Closed</span>
                            </div>
                            <div className="hidden w-2/12 2xsm:block md:w-1/12">
                                <button className="mx-auto block hover:text-meta-1">
                                    <svg className="mx-auto fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
